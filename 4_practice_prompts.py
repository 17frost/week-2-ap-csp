...
learning = print(input("What are you learning today"))
print(learning)
...
# Write Python code that allows the user to enter their answer, by making them the following question:
# Where are you from?
from1 = print(input("Where are you from?"))
print(from1)
# Your code must be able to print to the screen whatever is entered by the user (use the print function).
...
# What is your name?
first = print(input(" What is your first name?"))
print(first)
# What is your surname?
last = print(input("What is your surname?"))
print(last)
...
color = print(input(" What is your fav color?"))
print(color)
# What is your surname?
names = print(input("What is your name"))
print(names)
